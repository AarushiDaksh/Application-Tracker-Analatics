...
export default function SignInPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        setLoading(false);
        return setError(data.error || "Failed to sign in");
      }
    ...
    <div className="min-h-screen grid place-items-center px-4 bg-gradient-to-b from-white to-zinc-100 dark:from-black dark:to-neutral-900">
      ...
      >
        ...
        <div className="space-y-3">
          <button
            disabled={loading}
            className="w-full rounded-lg px-3 py-2.5 bg-blue-600 text-white hover:bg-blue-500 
        ...
        <p className="text-sm text-center">
          New here?{" "}
          <a className="underline hover:text-blue-600" href="/sign-up">
            Create an account
          </a>
        </p>
      </form>
